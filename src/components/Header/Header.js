    ...
    return (
            ...
            <div className="Header-Inner">
                ...
                <nav className="Header-Nav">
                    <NavLink to="/courses" className="Header-NavLink" style={navLinkStyles} > 
                        Courses
                    </NavLink>

                  
                    <div className="Header-NavButton"  > <Button modifiers={['nav']} >Sign In</Button> </div>
                    <div className="Header-NavButton"  > <Button modifiers={['nav', 'secondary']}>Register</Button></div>
                </nav>
            </div>
